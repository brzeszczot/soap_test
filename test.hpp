...
@code
  int soap_call_ns1__AccountAuth(
    ...
    std::string                         proj_USCOREhash,
    std::string                         email_USCOREhash,
    // output parameters:
    struct ns1__AccountAuthResponse&
  );
@endcode
...
int ns1__AccountAuth(
    ...
    std::string                         _proj,	///< Input parameter
    std::string                         _timestamp,	///< Input parameter
    std::string                         _proj_USCOREhash,	///< Input parameter
    std::string                         _email_USCOREhash,	///< Input parameter
