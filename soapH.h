...
inline struct ns1__AccountAuth * soap_new_req_ns1__AccountAuth(struct soap *soap, const std::string& _email, const std::string& _pass, int _proj_USCOREid, const std::string& _proj_USCOREhash) { struct ns1__AccountAuth *_p = soap_instantiate_ns1__AccountAuth(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns1__AccountAuth(soap, _p); _p->_email = _email; _p->_pass = _pass; _p->_proj_USCOREid = _proj_USCOREid; _p->_proj_USCOREhash = _proj_USCOREhash; } return _p; }

inline struct ns1__AccountAuth * soap_new_set_ns1__AccountAuth(struct soap *soap, const std::string& _email, const std::string& _pass, int _proj_USCOREid, const std::string& _proj_USCOREhash) { struct ns1__AccountAuth *_p = soap_instantiate_ns1__AccountAuth(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_ns1__AccountAuth(soap, _p); _p->_email = _email; _p->_pass = _pass; _p->_proj_USCOREid = _proj_USCOREid; _p->_proj_USCOREhash = _proj_USCOREhash; } return _p; }
